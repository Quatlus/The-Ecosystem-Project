class EsHead {
  ...
  showEyes () {
    ...
    if (this.eye == 15) {
      ...
      fill("#000000");
      stroke(200);
      ellipse(this.eyesposition.x+mod*1.3, this.eyesposition.y+mody*.5, this.eye-7, this.eye-7);
      ellipse(this.eyesposition.x-mod*1.3, this.eyesposition.y+mody*.5, this.eye-7, this.eye-7);
      fill("#ff6666");
      stroke("#ff6666");
      noStroke();
      ...
      stroke(200);
      ellipse(this.eyesposition.x+mod*1.3, this.eyesposition.y+mody*.6, this.eye, this.eye);
      ellipse(this.eyesposition.x-mod*1.3, this.eyesposition.y+mody*.6, this.eye, this.eye);
    }
